...
<div class="carre carre_principal">
    ...
    <div class="titreTexte">
        ...
        <form id="exportValid" target="_blank" 
              action="./?action=pdfecheances&export=valid&interval=<?php echo $interval[0].'@'.$interval[1]; ?>" method="POST"></form>
        
        <form action="./?action=lesreglements" method="POST">
        ...
        <input form="exportValid" type="submit" class="btn btn_recherche sort" name="confirmExport" value="Exporter la liste">
